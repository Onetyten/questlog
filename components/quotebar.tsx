...
export default function Quotebar() {
  ...
  return (
    <div className='w-[80%] min-h-32 gap-2 2xl:p-3 p-2 2xl:py-12 py-3 bg-background 2xl:text-base text-sm flex justify-center items-center flex-col text-center'>
